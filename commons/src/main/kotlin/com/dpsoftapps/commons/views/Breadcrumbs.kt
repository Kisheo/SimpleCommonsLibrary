...
class Breadcrumbs(context: Context, attrs: AttributeSet) : HorizontalScrollView(context, attrs) {
    ...
    private fun addBreadcrumb(item: FileDirItem, index: Int, addPrefix: Boolean) {
        if (itemsLayout.childCount == 0) {
            ...
            val view = inflater.inflate(R.layout.item_breadcrumb_first, itemsLayout, false)
            val binding = ItemBreadcrumbFirstBinding.bind(view)
            binding.apply {
                resources.apply {
            ...
            val view = inflater.inflate(R.layout.item_breadcrumb, itemsLayout, false)
            val binding = ItemBreadcrumbBinding.bind(view)
            binding.apply {
