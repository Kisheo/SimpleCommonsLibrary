...
import com.dpsoftapps.commons.adapters.PasswordTypesAdapter
...
import com.dpsoftapps.commons.views.MyDialogViewPager
import com.dpsoftapps.commons.databinding.DialogSecurityBinding
...
class SecurityDialog(
    ...
    private val binding: DialogSecurityBinding = DialogSecurityBinding.inflate(LayoutInflater.from(activity))
    ...
    init {
        binding.apply {
            ...
            tabsAdapter = PasswordTypesAdapter(
                ...
                biometricPromptHost = activity as FragmentActivity,
            ...
            if (showTabIndex == SHOW_ALL_TABS) {
                ...
                if (activity.baseConfig.isUsingSystemTheme) {
                    dialogTabLayout.setBackgroundColor(ContextCompat.getColor(root.context, R.color.you_dialog_background_color))
                } else {
                ...
                dialogTabLayout.onTabSelectionChanged(tabSelectedAction = {
                    viewPager.currentItem = when {
                        it.text.toString().equals(root.context.getString(R.string.pattern), true) -> PROTECTION_PATTERN
                        it.text.toString().equals(root.context.getString(R.string.pin), true) -> PROTECTION_PIN
